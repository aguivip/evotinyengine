package project.demo.modifier.post
{
	 ...
	 */
	public class ModifierPostGranulizerTwo extends AbstractModifier
	{
		...
		public function ModifierPostGranulizerTwo(id:String = "")
		{
			super(id);
		...
		{
			noiseMap.lock();						
			noiseMap.noise(data.deltatime, 255-Math.random()*128,255, BitmapDataChannel.ALPHA,true);
