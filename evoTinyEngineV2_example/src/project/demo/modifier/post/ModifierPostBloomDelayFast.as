package project.demo.modifier.post
{
	...
	public class ModifierPostBloomDelayFast extends AbstractModifier
	{
		...
		public function ModifierPostBloomDelayFast(bloomAmount:int = 32, blooms:int = 2, alpha:Number = 0.4, strong:Number = 0.6, color:uint = 0, colorAmount:Number = 0, fade:String = "fade_none", id:String = "")
		{
			super(id);
