package project.demo.modifier.post
{
	 ...
	 */
	public class ModifierPostShaderTime extends AbstractModifier
	{
		private var shader:Shader;
		
		private var _assets:Assets;
		public function ModifierPostShaderTime(shader:Shader, id:String = "")
		{
			super(id);
		...
		{
			shader.data.time.value = [data.time];
