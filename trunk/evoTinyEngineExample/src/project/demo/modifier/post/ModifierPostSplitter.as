package project.demo.modifier.post
{
	 ...
	 */
	public class ModifierPostSplitter extends AbstractModifier
	{
		private var mat:Matrix = new Matrix();
		private var cuts:int;
		
		private var _assets:Assets;
		public function ModifierPostSplitter(assets:AbstractAssets, cuts:int = 3, id:String = "")
		{
			super(assets, id);
		...
		override public function render(data:RenderData):void
		{
			...
			for(var y:int = 0;y<h;y+=he)
			{
				for(var x:int = 0;x<w;x+=wi)
				{
					mat.identity();
