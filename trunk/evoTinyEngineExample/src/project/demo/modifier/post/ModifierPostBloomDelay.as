package project.demo.modifier.post
{
	...
	public class ModifierPostBloomDelay extends AbstractModifier
	{
		...
		public function ModifierPostBloomDelay(assets:AbstractAssets, bloomAmount:int = 32, blooms:int = 2, alpha:Number = 0.4, strong:Number = 0.6, color:uint = 0, colorAmount:Number = 0, fade:String = ModifierPostBloomDelay.FADE_NONE, id:String = "")
		{
			super(assets, id);
