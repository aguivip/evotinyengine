package project.demo.modifier
{
	 ...
	 */
	public class ModifierSample extends AbstractModifier
	{
		private var _assets:Assets;
		private var color:uint;
		public function ModifierSample(assets:AbstractAssets, color:uint = 0xFFFFFF, id:String = "")
		{
			super(assets, id);
		...
		override public function render(data:RenderData):void
		{
			...
			this.bit.setPixel(w*Math.random(), h*Math.random(), color);
