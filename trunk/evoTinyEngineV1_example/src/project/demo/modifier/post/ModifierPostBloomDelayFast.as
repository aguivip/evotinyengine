package project.demo.modifier.post
{
	 ...
	 */
	public class ModifierPostBloomDelayFast extends AbstractModifier
	{
		...
		public function ModifierPostBloomDelayFast(assets:AbstractAssets, bloomAmount:int = 32, blooms:int = 2, alpha:Number = 0.4, strong:Number = 0.6, color:uint = 0, colorAmount:Number = 0, fade:String = ModifierPostBloomDelayFast.FADE_NONE, id:String = "")
		{
			super(assets, id);
