package project.demo.modifier.post
{
	 ...
	 */
	public class ModifierPostGlowStatic extends AbstractModifier
	{
		...
		public function ModifierPostGlowStatic(bloomAmount:int = 32, scaleRatio:int = 4, strong:Number = 0.4, redValue:Number = 0.3, greenValue:Number = 0.4, blueValue:Number = 0.5, blendmode:String = BlendMode.ADD, id:String = "")
		{
			super(id);
			...
			this.strong.redMultiplier = 1 + redValue;
			this.strong.greenMultiplier = 1 + greenValue;
			this.strong.blueMultiplier = 1 + blueValue;
