package project.demo.modifier.post
{
	...
	public class ModifierPostGlow extends AbstractModifier
	{
		...
		public function ModifierPostGlow(bloomAmount:int = 32, scaleRatio:int = 4, strong:Number = 0.4, redValue:Number = 0.3, greenValue:Number = 0.4, blueValue:Number = 0.5, blendmode:String = BlendMode.ADD, id:String = "")
		{
			super(id);
