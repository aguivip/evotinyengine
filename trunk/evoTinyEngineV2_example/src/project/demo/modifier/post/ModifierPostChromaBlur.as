package project.demo.modifier.post
{
	...
	public class ModifierPostChromaBlur extends AbstractModifier
	{
		...
		public function ModifierPostChromaBlur(offsetScale:Number = 5, blurColor1:ColorTransform = null, blurColor2:ColorTransform = null, blurColor3:ColorTransform = null, id:String = "")
		{
			super(id);
