package project.demo.modifier.post
{
	 ...
	 */
	public class ModifierPostBloomSurfaceFast extends AbstractModifier
	{
		...
		public function ModifierPostBloomSurfaceFast(assets:AbstractAssets, bloomAmount:int = 32, softAmount:int = 16, scaleRatio:int = 4, threshold:int = 32, strong:Number = 0.4, blendmode:String = BlendMode.ADD, id:String = "")
		{
			super(assets, id);
