package project.demo.modifier.post
{
	...
	public class ModifierPostSurfacePower extends AbstractModifier
	{
		...
		public function ModifierPostSurfacePower(assets:AbstractAssets, bloomAmount:int = 32, blooms:int = 2, alpha:Number = 0.4, strong:Number = 0.4, amount:int = 32, blendmode:String = BlendMode.HARDLIGHT, id:String = "")
		{
			super(assets, id);
